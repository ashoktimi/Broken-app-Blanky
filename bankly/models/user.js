...
/** Register user with data. Returns new user data. */
  ...
  static async register({username, password, first_name, last_name, email, phone, isAdmin=false}) {
    ...
    const result = await db.query(
      `INSERT INTO users 
        ...
        RETURNING username, password, first_name, last_name, email, phone, admin AS "isAdmin"`,
      [
        username,
        hashedPassword,
        first_name,
